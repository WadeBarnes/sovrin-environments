...
echo "/usr/bin/env python3 -O /usr/local/bin/start_sovrin_node ${NODE_NAME} ${NODE_PORT} ${CLIENT_PORT}"
echo
exec /usr/bin/env python3 -O /usr/local/bin/start_sovrin_node ${NODE_NAME} ${NODE_PORT} ${CLIENT_PORT}
